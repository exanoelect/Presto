/********************************************************************************
** Form generated from reading UI file 'msgendukur.ui'
**
...
#ifndef UI_MSGENDUKUR_H
#define UI_MSGENDUKUR_H
...
public:
    ...
    void setupUi(QMainWindow *msgendukur)
    {
        if (msgendukur->objectName().isEmpty())
            msgendukur->setObjectName(QStringLiteral("msgendukur"));
        msgendukur->resize(512, 374);
        msgendukur->setStyleSheet(QStringLiteral("background-color: transparent;"));
        centralwidget = new QWidget(msgendukur);
...
"color:white;"));
        ...
        msgendukur->setCentralWidget(centralwidget);
        label_2->raise();
        btnYes->raise();
        label->raise();
        label_3->raise();
        label_4->raise();
        btnNo->raise();
        menubar = new QMenuBar(msgendukur);
        menubar->setObjectName(QStringLiteral("menubar"));
        menubar->setGeometry(QRect(0, 0, 512, 21));
        msgendukur->setMenuBar(menubar);
        statusbar = new QStatusBar(msgendukur);
        statusbar->setObjectName(QStringLiteral("statusbar"));
        msgendukur->setStatusBar(statusbar);

        retranslateUi(msgendukur);

        QMetaObject::connectSlotsByName(msgendukur);
    } // setupUi

    void retranslateUi(QMainWindow *msgendukur)
    {
        msgendukur->setWindowTitle(QApplication::translate("msgendukur", "MainWindow", nullptr));
        btnYes->setText(QString());
        btnNo->setText(QString());
        label->setText(QApplication::translate("msgendukur", "PENGUJIAN SELESAI ?", nullptr));
        label_2->setText(QString());
        label_3->setText(QApplication::translate("msgendukur", "CANCEL", nullptr));
        label_4->setText(QApplication::translate("msgendukur", "YES", nullptr));
    } // retranslateUi

};

namespace Ui {
    class msgendukur: public Ui_msgendukur {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_MSGENDUKUR_H
