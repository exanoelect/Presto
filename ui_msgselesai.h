/********************************************************************************
** Form generated from reading UI file 'msgselesai.ui'
**
...
#ifndef UI_MSGSELESAI_H
#define UI_MSGSELESAI_H
...
public:
    ...
    void setupUi(QMainWindow *msgselesai)
    {
        if (msgselesai->objectName().isEmpty())
            msgselesai->setObjectName(QStringLiteral("msgselesai"));
        msgselesai->resize(512, 374);
        msgselesai->setStyleSheet(QStringLiteral("background-color: transparent;"));
        centralwidget = new QWidget(msgselesai);
...
"color:white;"));
        ...
        msgselesai->setCentralWidget(centralwidget);
        label_2->raise();
        btnYes->raise();
        label->raise();
        label_3->raise();
        label_4->raise();
        btnNo->raise();
        menubar = new QMenuBar(msgselesai);
        menubar->setObjectName(QStringLiteral("menubar"));
        menubar->setGeometry(QRect(0, 0, 512, 21));
        msgselesai->setMenuBar(menubar);
        statusbar = new QStatusBar(msgselesai);
        statusbar->setObjectName(QStringLiteral("statusbar"));
        msgselesai->setStatusBar(statusbar);

        retranslateUi(msgselesai);

        QMetaObject::connectSlotsByName(msgselesai);
    } // setupUi

    void retranslateUi(QMainWindow *msgselesai)
    {
        msgselesai->setWindowTitle(QApplication::translate("msgselesai", "MainWindow", nullptr));
        btnYes->setText(QString());
        btnNo->setText(QString());
        label->setText(QApplication::translate("msgselesai", "PENGUJIAN SELESAI ?", nullptr));
        label_2->setText(QString());
        label_3->setText(QApplication::translate("msgselesai", "CANCEL", nullptr));
        label_4->setText(QApplication::translate("msgselesai", "YES", nullptr));
    } // retranslateUi

};

namespace Ui {
    class msgselesai: public Ui_msgselesai {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_MSGSELESAI_H
